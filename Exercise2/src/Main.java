public class Main {
    ...
    public static void main(String[] args) {
        ...
        Heavyweight ProcessA = new Heavyweight(true, PROCESS_A_ID,
                PROCESS_A_PORT, PROCESS_B_PORT);
        Heavyweight ProcessB = new Heavyweight(false, PROCESS_B_ID,
                PROCESS_B_PORT, PROCESS_A_PORT);
